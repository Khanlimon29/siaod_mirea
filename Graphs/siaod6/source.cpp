    ...
    vector<int> EulerianCycle() {
        for (int startVertex = 0; startVertex < NumVertices; ++startVertex) {
            ...
            if (eulerianCycle.front() == eulerianCycle.back() && eulerianCycle.size() != 1) {
                cout << "\nЭйлеров цикл найден, начальная вершина: " << startVertex << endl;
                for (int vertex : eulerianCycle) cout << vertex << " ";
                return eulerianCycle;
            }
        }
        cout << "\nЭйлеров цикл не найден" << endl;
        return vector<int>();
    }
...
int main() {
    ...
    while (ch != 27) {
        ...
        cout << "\n1. Добавить узел\n2. Добавить грань\n3. Очистить граф\n"
            ...
            << "6. Ввод тестового значения 1(Эйлеров цикл есть)\n7. Ввод тестового значения 2(Эйлеров цикл отсутсвует)\n"
            << "8. Ввод тестового значения 3(Алгоритм Прима)\n9. Ввод тестового значения 4(Алгоритм Прима)\n"
            << "0. Ввод тестового значения 5(Алгоритм Прима)(методичка)\n\nEsc.Выход из программы\n";
        ...
        case '4': {
            vector<int> eulerianCycle = graph.EulerianCycle();
            _getch();
            break;
        }
